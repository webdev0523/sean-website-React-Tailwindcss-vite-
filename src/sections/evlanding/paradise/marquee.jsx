        ...
        <>
            ...
            <div className="relative origin-bottom -rotate-[2.54deg] scrolling-text-container">
                <div className="md:h-[70px] h-[40px] w-full flex items-center scrolling-text-right">
                    <p behavior="scroll" direction="left" className="text-white font-['Neuething'] text-lg md:text-2xl font-extrabold drop-shadow-[1px_-1px_0px_rgba(0,0,0)] whitespace-pre ">ISUZU D-MAX X-Terrain   |   GIVEAWAY   |   ISUZU D-MAX X-Terrain   |   GIVEAWAY   |   $50,000 CASH   |   GIVEAWAY   |   ISUZU D-MAX X-Terrain   |   GIVEAWAY    |    </p>
                    <p behavior="scroll" direction="left" className="text-white font-['Neuething'] text-lg md:text-2xl font-extrabold drop-shadow-[1px_-1px_0px_rgba(0,0,0)] whitespace-pre ">ISUZU D-MAX X-Terrain   |   GIVEAWAY   |   ISUZU D-MAX X-Terrain   |   GIVEAWAY   |   $50,000 CASH   |   GIVEAWAY   |   ISUZU D-MAX X-Terrain   |   GIVEAWAY </p>
                </div>
