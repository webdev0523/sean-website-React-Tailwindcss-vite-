...
const WinA = ({ property, className, style }) => {
  return (
    <div className="w-full mb-0 relative px-5">
      ...
      <div className="text-center md:p-24 p-8 max-md:my-8">
      ...
      <div className="flex lg:flex-row flex-col justify-center items-center w-full">
        <div className="flex flex-col justify-center items-center max-lg:items-start w-full">
          ...
          <div className="text-center relative mt-16 origin-bottom -rotate-[2.54deg] max-lg:mt-[-50px] max-lg:ml-[100px]">
            <p className="font-['Neuething'] text-4xl max-md:text-[19px] text-medium  drop-shadow-[2px_-2px_0px_rgba(255,255,255)] ">
              Brand New
            </p>
            <p className="font-['Neuething'] text-4xl max-md:text-[19px] font-black mt-4 drop-shadow-[2px_-2px_0px_rgba(255,255,255)]">
              Tesla Model Y
            </p>
        ...
        <div className="flex flex-col justify-center items-center max-lg:items-end w-full">
          ...
          <div className="text-center mt-16 relative origin-bottom -rotate-[2.54deg] max-lg:mt-[-50px] max-lg:mr-[100px]">
            <p className="font-['Neuething'] text-4xl drop-shadow-[2px_-2px_0px_rgba(255,255,255)]  text-medium max-md:text-[19px]">
              Or Brand New
            </p>
            <p className="font-['Neuething'] text-4xl mt-4 drop-shadow-[2px_-2px_0px_rgba(255,255,255)]  font-black max-md:text-[19px] ">
              Isuzu DMax
            </p>
        ...
        <div className="flex justify-center w-full">
          <img
            src={curvearrow2}
            alt="curvearrow"
            className="mt-12 lg:mt-48 max-lg:!display-none "
          />
          <img
            src={curvearrow3}
            alt="curvearrow"
            className="mt-12 lg:mt-48 lg:!display-none"
          />
        </div>
        ...
        <div className="flex flex-col justify-center items-center max-lg:items-start w-full">
          ...
          <div className="text-center mt-16 relative origin-bottom -rotate-[2.54deg] max-lg:mt-[-50px] max-lg:ml-[100px]">
            ...
            <p className="font-['Neuething'] font-black text-4xl mt-4 drop-shadow-[2px_-2px_0px_rgba(255,255,255)] max-md:text-[19px] ">
              USD CASH
            </p>
