    ...
    <div className="bg-[url('/hero/Mask_group.png')] bg-center bg-no-repeat bg-cover bg-[length:100%_100%] relative">
      ...
      <div className="flex lg:flex-row flex-col justify-evenly">
        <div className=" px-5 lg:px-0">
          <div className="origin-center -rotate-[3.33deg] max-[1024px]:text-center">
            <p className="text-2xl mb-4 leading-6 font-['Neuething'] font-normal drop-shadow-[3px_-3px_0px_rgba(255,255,255)]">WELCOME TO OUR</p>
            <p className="text-5xl md:text-8xl leading-[72px] text-[#FF4C00] font-['Neuething'] font-extrabold drop-shadow-[3px_-3px_0px_rgba(255,255,255)]">BIGGEST </p>
            <p className="text-4xl md:text-8xl leading-[72px] text-black font-['Neuething'] font-extrabold drop-shadow-[3px_-3px_0px_rgba(255,255,255)]">GIVEAWAY </p>
            <p className="text-4xl md:text-8xl leading-[72px] text-black font-['Neuething'] font-extrabold text-center pr-4 drop-shadow-[3px_-3px_0px_rgba(255,255,255)]">YET! </p>
          </div>
          {/*  */}
          <div className="relative mt-8" >
            {/* <img src={vector} alt="vector" className="absolute bottom-[150px] left-[80px] w-100%" /> */}
            <svg className="absolute bottom-[100px] left-[-50px] w-100% lg:w-[878px]" viewBox="0 0 878 572" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <img src={tape} alt="tape" className="absolute right-0 lg:right-[-100px] top-0" />
            <img src={cash} alt="cash" className="lg:z-[100] z-[-1]  relative" />
          </div>
        </div>
        {/*  */}
