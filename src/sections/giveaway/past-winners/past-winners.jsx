...
import logo from "../../../assets/giveaway/past-winners/logo.svg";
...
export default function PastWinners() {
  ...
  return (
    <div ref={targetRef} className="md:p-0 p-8 relative">
      ...
      <div
        className={`max-md:!display-none grid grid-cols-4 gap-4 max-w-[1200px] mx-auto duration-[2000ms] relative max-md:grid-cols-4 max-md:gap-1 md:p-4 ${isIntersecting ? "opacity-1" : "opacity-0"
          }`}
      >
