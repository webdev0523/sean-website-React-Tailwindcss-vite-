  ...
  return (
    <div className="bg-[url('/hero/Mask_group.png')] bg-center bg-no-repeat bg-cover bg-[length:100%_100%] relative">
      ...
      <div className="flex justify-evenly">
        <div>
          <div className="origin-center -rotate-[3.33deg]">
            <p className="text-2xl leading-6 font-['Neuething'] font-normal drop-shadow-[3px_-3px_0px_rgba(255,255,255)]">WELCOME TO OUR</p>
            <p className="text-6xl leading-[72px] text-[#FF4C00] font-['Neuething'] font-extrabold drop-shadow-[3px_-3px_0px_rgba(255,255,255)]">BIGGEST </p>
            <p className="text-6xl leading-[72px] text-black font-['Neuething'] font-extrabold drop-shadow-[3px_-3px_0px_rgba(255,255,255)]">GIVEAWAY </p>
            <p className="text-6xl leading-[72px] text-black font-['Neuething'] font-extrabold text-right pr-4 drop-shadow-[3px_-3px_0px_rgba(255,255,255)]">YET! </p>
          </div>
          {/*  */}
          <div className="relative mt-8" >
            {/* <img src={vector} alt="vector" className="absolute bottom-[150px] left-[80px] w-100%" /> */}
            <svg className="absolute bottom-[100px] left-[-50px] w-100%" width="878" height="572" viewBox="0 0 878 572" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <img src={tape} alt="tape" className="absolute right-[-200px] top-0" />
            <img src={cash} alt="cash" className="z-100 relative" />
          </div>
        </div>
        {/*  */}
        <div>
          <img src={car1} alt="car1" />
          <img src={car2} alt="car2" className="mt-[-74px]" />
        </div>
      </div>
